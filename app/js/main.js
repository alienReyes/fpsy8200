...
$.getJSON('js/data.json', function(data) {
    var template = document.getElementById('figureTemplate').innerHTML;
...
$('body').on('click', '.clickFigure', function(e) {
  e.preventDefault();
  var refId=$(this).data('target');
  if (refId==currRefId){
    console.log (e.target)
     playPauseHandler();
  }
  else {
       kdp.sendNotification("changeMedia", { "referenceId" : refId });
       currRefId=refId;
  }
});
